~function () {
   /* var effect = { //这一组对象里都是存放如何去计算当前位置的公式
     ...
     * @param effect  1,2,3  三种不同的效果
     * @param callback   function 运动之后在执行的方法。
     */
    ...
    function move(curEle, target, duration,effect,callback) { //驱动元素运动的 //target{width:100,left:50}
        ...
        if(typeof effect == 'number'){
            switch (effect){
                case 1:   tempEffect = zhufengEffect.Bounce.easeIn;
                    break;
                case 2:   tempEffect = zhufengEffect.Bounce.easeOut;
                    break;
                case 3:   tempEffect = zhufengEffect.Bounce.easeInOut;
                    break;
                case 4:   tempEffect = zhufengEffect.Linear;
                    break;
            }
